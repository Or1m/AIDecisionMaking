...
class D45:
    def __process_continuous_features(self, df, column_name, entropy):
        ...
        for i in range(0, len(unique_values) - 1):
            ...
            threshold_splitinfo = -subsetA_probability * math.log(subsetA_probability, 2) - subsetB_probability * math.log(subsetB_probability, 2)
        ...
        winner = subset_gainratios.index(max(subset_gainratios))
    ...
    def __find_decision(self, df):
        ...
        winner_idx = gainratios.index(max(gainratios))
    ...
    def build_decision_tree(self, df, root):
        ...
        for i in range (0, len(classes)):
            ...
            self.__print_output(root, subdataset, winner_name, current_class)
            root = tmp_root * 1

    def __print_output(self, root, subdataset, winner_name, current_class):
